...
const skillCategories = [
  {
    ...
    skills: [
      { name: 'Debian/Linux Server', level: 89 },
      { name: 'Windows Server', level: 75 },
      { name: 'Web Server (Apache/Nginx)', level: 100 },
      { name: 'Certification Authority', level: 88 },
      { name: 'DNS & DHCP', level: 100 },
      { name: 'Mail Server', level: 70 },
      { name: 'OpenVPN', level: 66 },
      { name: 'IPTables/NFTables', level: 77 },
      { name: 'HAProxy', level: 71 },
      { name: 'Keepalived', level: 80 },      
      { name: 'Ansible', level: 76 },
      { name: 'VMware ESXi & Proxmox', level: 90 }
    ],
  },
  {
    icon: Network,
  ...
  },
  {
    ...
    skills: [
      { name: 'Arduino (Uno/Mega/Nano)', level: 80 },
      { name: 'Raspberry Pi 3 & 4', level: 71 },
      { name: 'ESP32 / ESP8266', level: 77 },
      { name: 'IoT Modules', level: 89 },
    ],
  },
];
